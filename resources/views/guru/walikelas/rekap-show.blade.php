...
@section('page-title', 'Detail Rekap')
@section('breadcrumb', 'Wali Kelas / Detail Sesi')
...
<style>
    ...
    .info-value {
        font-family: 'Plus Jakarta Sans', sans-serif;
        font-size: 18px; font-weight: 800; color: var(--text1); line-height: 1.1;
    }
    .info-icon { font-size: 14px; margin-right: 4px; }
    ...
    .donut-container { width: 100px; height: 100px; position: relative; flex-shrink: 0; }
    .donut-center {
    ...
    .donut-pct {
        font-family: 'Plus Jakarta Sans', sans-serif;
        font-size: 22px; font-weight: 800; color: var(--text1); line-height: 1;
    }
    ...
    .sb-hadir { background: rgba(63,185,80,0.1); color: var(--green); border: 1px solid rgba(63,185,80,0.2); }
    .sb-alpa { background: rgba(248,81,73,0.1); color: var(--red); border: 1px solid rgba(248,81,73,0.2); }
    .time-cell {
...
<a href="{{ route('guru.walikelas.index') }}" class="btn-back">
    <i class="bi bi-arrow-left"></i> Kembali ke Rekap Kelas
</a>

{{-- HEADER --}}
<div class="page-header">
    <div class="page-header-left">
        <div class="page-title">Rekap Sesi — {{ $namaKelas }}</div>
...
<div style="display:grid; grid-template-columns: 1fr auto; gap:16px; margin-bottom:20px; align-items:start;">
    <div class="info-grid" style="margin-bottom:0">
        ...
        <div class="info-card">
            ...
            <div class="info-value" style="color:var(--purple)">{{ $namaKelas }}</div>
        </div>
        <div class="info-card">
    ...
    <div class="donut-card">
        <div class="donut-container">
            <svg viewBox="0 0 36 36" style="width:100%; height:100%; transform:rotate(-90deg)">
                <circle cx="18" cy="18" r="15.5" fill="none" stroke="var(--navy3)" stroke-width="3.5" />
