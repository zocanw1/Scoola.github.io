...
<style>
    ...
    /* Fallback Tata Letak (PENTING: Mencegah tampilan bertumpuk jika Tailwind lokal mati) */
    ...
    /* Spacing & Ukuran Standar (Pixel Fallback) */
    ...
    /* Latar Belakang Bermotif */
    .pattern-dot {
        background-image: radial-gradient(#6C5CE7 1.5px, transparent 0);
...
<div class="font-anime-body text-[#1E1B29] min-h-screen w-full -m-6 p-6" background-image: radial-gradient(#6C5CE7 0.5px, transparent 0); background-size: 32px 32px; background-attachment: fixed;">
