                    ...
                    <td>
                        <div class="action-group" style="justify-content:center">
                            ...
                            <form action="{{ route('siswa.destroy', $s->NIS) }}"
                                  ...
                                  onsubmit="return confirmDelete(event, '{{ $s->nama_siswa }}')">
                                @csrf
                                @method('DELETE')
...
<div id="deleteModal" style="
    ...
    z-index:999; place-items:center; display:none;
">
    <div style="
    ...
    ">
        ...
        <div style="font-size:12.5px; color:var(--text2); margin-bottom:22px; line-height:1.6">
            Data siswa <strong id="modalStudentName" style="color:var(--text1)"></strong> akan dihapus secara permanen dan tidak dapat dikembalikan.
        </div>
        ...
        <div style="display:flex; gap:10px; justify-content:center">
            ...
            " onmouseenter="this.style.color='var(--text1)'" onmouseleave="this.style.color='var(--text2)'">
                Batal
            </button>
...
<script>
    ...
    function filterTable() {
        ...
        rows.forEach(row => {
            ...
            const rowKl = row.dataset.kelas.toLowerCase();

            const matchQ = !q || name.includes(q) || nis.includes(q);
            const matchK = !kelas || rowKl === kelas;
        ...
        if (visible === 0) noResult.style.flexDirection = 'column';
    }
