...
<body class="p-4 md:p-10">
    ...
    <main class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-10">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <div class="relative p-6 neo-brutalism card-hover">
                    <span class="sticker text-[#1E1B29]" style="background-color: <?php echo e($member->sticker_bg ?? '#FDCB6E'); ?>;">
                        <?php echo e(strtoupper($member->role)); ?>

                    </span>

                    <div class="w-full img-container mb-6 <?php echo e($currentRotation); ?>" style="background-color: <?php echo e($member->img_bg ?? '#6C5CE7'); ?>;">
                        <?php if($member->photo): ?>
                            <img src="<?php echo e(asset('storage/team-photos/' . $member->photo)); ?>" 
                                 alt="<?php echo e($member->name); ?>" 
                                 class="w-full h-full object-cover"
                                 onerror="this.src='https://via.placeholder.com/400/<?php echo e(str_replace('#', '', $member->img_bg ?? '6C5CE7')); ?>?text=<?php echo e(urlencode($member->name)); ?>'">
                        <?php else: ?>
                    ...
                    <h2 class="fredoka text-2xl mb-1"><?php echo e($member->name); ?></h2>
                    <p class="font-bold mb-4 uppercase text-sm tracking-widest" style="color: <?php echo e($member->role_color ?? '#FF7675'); ?>;">
                        <?php echo e($member->kelas); ?>

                    </p>
                    <p class="text-sm opacity-80 mb-4 italic leading-relaxed">"<?php echo e($member->description); ?>"</p>
                    
                    <div class="mb-4 text-xs text-gray-700 leading-relaxed text-justify border-b-2 border-dashed border-gray-300 pb-4">
                        <p><strong>Jobdesk:</strong> <?php echo e($member->jobdesk); ?></p>
                    </div>

                    <div class="info-snippet p-3 mb-4 text-xs space-y-1">
                        <p><strong>NIS:</strong> <?php echo e($member->nis); ?></p>
                        <p><strong>TTL:</strong> <?php echo e($member->birthplace); ?>, <?php echo e(\Carbon\Carbon::parse($member->birthdate)->format('d M Y')); ?></p>
                        <p><strong>Telp:</strong> <?php echo e($member->phone); ?></p>
                    </div>

                    <div class="flex gap-2 justify-center flex-wrap">
                        <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skillIndex => $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <span class="px-3 py-1 border-2 border-black font-bold text-xs" style="background-color: <?php echo e($badgeBg); ?>; color: <?php echo e($badgeText); ?>;">
                                <?php echo e(strtoupper($skill)); ?>
...
</html><?php /**PATH C:\coding\laravel\Scoola\resources\views/Portofolio.blade.php ENDPATH**/ ?>