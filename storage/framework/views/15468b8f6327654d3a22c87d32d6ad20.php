...
<div style="display: flex; flex-direction: column; gap: var(--spacing-md);">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(340px, 1fr)); gap: var(--spacing-md);">
        ...
        <div class="card" style="background: #ffffff; padding: 40px; border-radius: 12px; border: 1px solid var(--color-hairline); position: relative; overflow: hidden;">
            ...
            <div style="padding-left: 12px;">
                ...
                <div style="font-size: 56px; color: var(--color-ink); font-weight: 400; letter-spacing: var(--tracking-tighter); line-height: 1;"><?php echo e($mapel->count()); ?></div>
            </div>
        </div>
        ...
        <div class="card" style="background: #ffffff; padding: 40px; border-radius: 12px; border: 1px solid var(--color-hairline); position: relative; overflow: hidden;">
            ...
            <div style="padding-left: 12px;">
                ...
                <div style="font-size: 56px; color: var(--color-ink); font-weight: 400; letter-spacing: var(--tracking-tighter); line-height: 1;"><?php echo e(App\Models\Guru::count()); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="card table-container-card" style="margin-bottom: var(--spacing-section);">
        <table class="data-table responsive-table" style="margin: 0; width: 100%;">
            ...
            <tbody id="mapelTable">
                <?php $__empty_1 = true; $__currentLoopData = $mapel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="mapel-row">
                    <td data-label="No" style="padding-left: 40px; color: var(--color-stone);"><?php echo e($key + 1); ?></td>
                    <td data-label="Kode" style="color: var(--color-ink); font-weight: 600; font-family: monospace;"><?php echo e($m->kd_mapel); ?></td>
                    <td data-label="Mata Pelajaran" style="font-weight: 600;"><?php echo e($m->nama_mapel); ?></td>
                    <td data-label="Aksi" style="text-align: right; padding-right: 40px;">
                        <a href="<?php echo e(route('mapel.edit', $m->kd_mapel)); ?>" class="btn-ghost" style="height: 32px; font-size: 11px; padding: 0 16px; text-decoration: none; display: inline-flex; align-items: center;">Edit</a>
                    </td>
                </tr>
...
document.getElementById('mapelSearch').addEventListener('keyup', function() {
    ...
    <div class="fab-container">
        <a href="<?php echo e(route('mapel.create')); ?>" class="btn-fab" title="Tambah Mapel">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\coding\laravel\Scoola\resources\views/admin/mapel/index.blade.php ENDPATH**/ ?>