...
<div style="display: flex; flex-direction: column; gap: var(--spacing-md);">
    ...
    <div class="card" style="background: #ffffff; padding: 40px; border-radius: 12px; border: 1px solid var(--color-hairline); position: relative; overflow: hidden;">
        ...
        <div style="padding-left: 12px;">
            ...
            <div style="font-size: 56px; color: var(--color-ink); font-weight: 400; letter-spacing: var(--tracking-tighter); line-height: 1;"><?php echo e($admins->count()); ?> <span style="font-size: 24px; letter-spacing: 0;">Akun</span></div>
        </div>
    </div>
    ...
    <div class="card table-container-card" style="margin-bottom: var(--spacing-section);">
        <table class="data-table responsive-table" style="margin: 0; width: 100%;">
            ...
            <tbody>
                <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td data-label="#" style="padding-left: 40px; color: var(--color-stone);"><?php echo e($index + 1); ?></td>
                    <td data-label="Nama" style="font-weight: 600;"><?php echo e($a->name); ?></td>
                    <td data-label="Username" style="font-family: monospace; color: var(--color-slate);"><?php echo e(explode('@', $a->email)[0]); ?></td>
                    <td data-label="Email" style="color: var(--color-graphite);"><?php echo e($a->email); ?></td>
                    <td data-label="Aksi" style="text-align: right; padding-right: 40px;">
                        <a href="<?php echo e(route('admin.akun.edit', $a->id)); ?>" class="btn-ghost" style="height: 32px; font-size: 11px; padding: 0 16px; text-decoration: none; display: inline-flex; align-items: center;">Edit</a>
                    </td>
                </tr>
...
<div class="fab-container">
    <a href="<?php echo e(route('admin.akun.create')); ?>" class="btn-fab" title="Tambah Admin">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\coding\laravel\Scoola\resources\views/admin/akun/admin-index.blade.php ENDPATH**/ ?>